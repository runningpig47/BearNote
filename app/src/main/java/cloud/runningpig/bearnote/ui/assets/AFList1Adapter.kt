...
import cloud.runningpig.bearnote.databinding.AfListItemBinding
import cloud.runningpig.bearnote.logic.model.Account
import cloud.runningpig.bearnote.logic.model.IconMap

class AFList1Adapter(private val onItemClick: (item: Account, position: Int) -> Unit) :
    ListAdapter<Account, AFList1Adapter.ViewHolder>(ItemComparator()) {
    ...
    class ViewHolder(val binding: AfListItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        companion object {
            fun create(parent: ViewGroup): ViewHolder {
                return ViewHolder(AfListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
            }
        }
